# Public APIs - Curated by zeroxn8877021

A collective list of free APIs for use in software and web development.

<br >

The Public APIs repository is manually curated by community members. It includes an extensive list of public APIs from many domains that you can use for your own products. Consider it a treasure trove of APIs well-managed by the community over the years.
